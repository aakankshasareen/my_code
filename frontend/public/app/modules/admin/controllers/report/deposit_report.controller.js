admin.controller("depositReportCtrl", ['$rootScope', '$scope', '$timeout', 'loginService', 'dashboardService', 'AuthService', 'adminService', '$state', 'toastr', 'paginationFactory', '$stateParams', '$window', 'uiGridConstants',
    function($rootScope, $scope, $timeout, loginService, dashboardService, AuthService, adminService, $state, toastr, paginationFactory, $stateParams, $window, uiGridConstants) {
        ...
        var vm = this;
        var searchParams = [];
        $scope.pageHeading = "Deposit Report";
        $scope.orderCoulmn = '';
        ...
        $scope.export = function(format) {
            ...
            var result = adminService.getDepositReport(data);
            result.then(
                function(response) {
