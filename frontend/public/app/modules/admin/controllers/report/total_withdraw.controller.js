admin.controller("totalWithdrawCtrl", ['$rootScope', '$scope', '$timeout', 'loginService', 'dashboardService', 'AuthService', 'adminService', '$state', 'toastr', 'paginationFactory', '$stateParams', '$window', 'uiGridConstants',
    function ($rootScope, $scope, $timeout, loginService, dashboardService, AuthService, adminService, $state, toastr, paginationFactory, $stateParams, $window, uiGridConstants) {
        ...
        var vm = this;
        $scope.pageHeading = "Total Withdrawals";
        ...
        $scope.getGridData = function () {
            $scope.gridOptions = {
                ...
                exporterCsvFilename: 'totalWithdraw.csv',
                ...
                columnDefs: [
                    { field: 'serial_number', name: 'S.No.', width: '80', enableSorting: false, enableFiltering: false, cellTemplate: '<span>{{rowRenderIndex+1}}</span>', headerCellClass: 'text-center', cellClass: 'text-center' },
                    {
                        field: 'currency_code',
                        filter: {
                            placeholder: 'Search...'
        ...
        $scope.export = function (format) {
            ...
            var result = adminService.getTotalWithdrawal(data);
            result.then(
                function (response) {
