admin.controller("contactCtrl", ['$rootScope', '$scope', '$window','SUPPORT_TYPE', 'adminService', '$state', 'toastr', 'paginationFactory', '$stateParams', 'Upload', 'uiGridConstants', '$timeout',
        ...
        $scope.getGridData = function () {
            $scope.gridOptions = {
                ...
                columnDefs: [
                    ...
                    {
                        field:'description', headerCellClass: 'text-left', name: 'Description', width: '*', filter: {
                            placeholder: 'Search...'
                        }
                    },
