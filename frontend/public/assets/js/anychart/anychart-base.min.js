...
$.le(this.F,{href:a?this.KB():"",title:c.replace("{{anychart-version}}",b),target:"_blank"}),$.le(this.b,{alt:a?this.JB():"AnyChart - JavaScript Charts"}),this.W(hk));this.X(ik)&&(a=a?this.text():"",$.Je(this.o,a),this.W(ik));if(this.X(jk)){if(a=this.Tp()?this.Mx():lk()){if(this.P=a,b=ah($.Kf()))$.fd(b,"complete",this.YU,!1,this),$.fd(b,"load",this.wP,!1,this),$.fd(b,"error",this.ZU,!1,this),this.B&&(Ng(b,a),this.B=!1),$.Lg(b,a,a),this.B=
